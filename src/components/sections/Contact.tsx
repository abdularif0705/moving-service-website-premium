        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-serif mb-6 leading-tight">
              ...
              <span className="text-accent italic pr-2 -mr-2">Let's</span> <span className="text-accent italic pr-2 -mr-2">get</span> <span className="text-accent italic pr-2 -mr-2">started.</span>
            </h2>
