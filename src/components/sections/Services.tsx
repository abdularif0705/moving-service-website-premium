    ...
    <section id="services" className="py-24 md:py-32 bg-foreground/5 dark:bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20 flex flex-col items-center">
          ...
          >
            Comprehensive <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent/70 italic pr-2 -mr-2">Moving</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent/70 italic pr-2 -mr-2">Services</span>
          </motion.h3>
        </div>
