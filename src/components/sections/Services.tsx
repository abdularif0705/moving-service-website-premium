      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          {services.map((service, index) => (
            ...
            >
              <div className="h-14 w-14 bg-white dark:bg-slate-800 ring-1 ring-black/[0.05] dark:ring-white/10 shadow-sm rounded-2xl flex items-center justify-center mb-6 group-hover:scale-105 group-hover:ring-accent/50 group-hover:shadow-md transition-all duration-500">
                <service.icon className="text-foreground group-hover:text-accent transition-colors duration-500" size={28} />
              </div>
