      ...
      <main className="flex-col overflow-hidden bg-foreground/5 dark:bg-background pb-20">
        ...
        <div className="bg-primary pt-40 pb-20 text-center relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto px-4 relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-serif text-white mb-6">Build a Career in <span className="text-accent italic pr-2 -mr-2">Premium</span> <span className="text-accent italic pr-2 -mr-2">Logistics.</span></h1>
